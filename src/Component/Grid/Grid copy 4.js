        ...
        if(e.statusText === 'OK'){
          ...
          for(let idx = 0; idx < header.length; idx++){
            ...
            for(let j = 0; j < each.length; j++){
              ...
              divMain.id = props.pgm + '_' + props.id + '_' + columnId;
              divMain.style = `width: ${each[j].clientWidth}; height: 100%; top: 0; cursor:move; position: absolute; background: transparent;`;
              each[j].appendChild(divMain);
              ...
              divLeft.id = props.pgm + '_' + props.id + '_' + columnId + '_LEFT';
              divLeft.style = `width: 50%; height: 100%; float:left; top: 0; background: transparent;`;
              divMain.appendChild(divLeft);
      
              const divRight = document.createElement('div');
              divRight.id = props.pgm + '_' + props.id + '_' + columnId + '_RIGHT';
