...
import { gfo_getCheckbox } from '../../Method/Component';
...
class Checkbox extends Component{
  ...
  constructor(props){
    ...
    if(gfo_getCheckbox(props.pgm, props.id) !== undefined){
      gfc_getMultiLang('dup', '체크박스 아이디 중복입니다. > ' + props.pgm + ', ' + props.id);
      return 
    } 

    this.inputRef = createRef();

    gfs_dispatch(props.pgm, 'INITCHECKBOX', 
      ({
  ...
  componentWillUnmount(){
    gfs_dispatch(this.props.pgm, 'CLEARCHECKBOX', 
      ({
        id: this.props.id
      })
    );
