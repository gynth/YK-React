...
class AUTH extends Component {
  ...
  Retrieve = async () => {
    ...
    if(this.selectedTab === 0){
      ...
      const mainGrid = await gfg_getGrid(this.props.pgm, 'main10');
      const dtlGrid  = await gfg_getGrid(this.props.pgm, 'detail10');
      
      if(search_tp === '3' || search_tp === '4'){

      }else if(search_tp !== null && search_tp !== '' && search_txt !== ''){
        mainGrid.clear();
        dtlGrid.clear();
        let main = retData1.filter(e => {
          //코드
          if(search_tp === '1'){
            if(e.AUTH_CD.toString().indexOf(search_txt) >= 0){
              return true;
            }else{
              return false;
            }
          ...
          //코드명
            ...
            if(e.AUTH_NAM.indexOf(search_txt) >= 0){
              return true;
            }else{
              return false;
            }
      ...
      if(search_tp === '1' || search_tp === '2'){

      }else if(search_tp !== null && search_tp !== '' && search_txt !== ''){
        mainGrid.clear();
        dtlGrid.clear();
        let main = retData2.filter(e => {
          //코드
          if(search_tp === '3'){
            if(e.AUTH_CD.toString().indexOf(search_txt) >= 0){
              return true;
              ...
              <div className='wp'>
                <div style={{width:'100%', height:'100%', overflow:'auto'}}>
                  ...
                  >
                    <Tabs 
                      onSelect={async e => {
                        gfs_dispatch(this.props.pgm, 'CLEARGRID', {
                          id: 'main10'
                        })
                        gfs_dispatch(this.props.pgm, 'CLEARGRID', {
                          id: 'main20'
